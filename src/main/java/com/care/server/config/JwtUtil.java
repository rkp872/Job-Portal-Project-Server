...
public class JwtUtil {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        if (roles.contains(new SimpleGrantedAuthority("SEEKER"))) {
            claims.put("isSeeker", true);
        }
    ...
    public List<SimpleGrantedAuthority> getRolesFromToken(String token) {
        ...
        Boolean isSeeker = claims.get("isSeeker", Boolean.class);
        ...
        else if (isSeeker != null) {
            roles = Arrays.asList(new SimpleGrantedAuthority("SEEKER"));
        }
